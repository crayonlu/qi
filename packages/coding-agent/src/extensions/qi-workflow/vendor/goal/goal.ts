// @ts-nocheck
import { defineTool, type ExtensionAPI } from "../pi-coding-agent-shim.ts";
...
import { buildGoalPrompt, buildGoalSystemPrompt } from "./prompts.ts";
import { activateQueuedGoal } from "./queue.ts";
import { GoalRpcController } from "./rpc.ts";
import {
