import type { Theme } from "../../pi-coding-agent-shim.ts";
import type { ProcessInfo } from "../constants/index.ts";

export function formatRuntime(startTime: number, endTime: number | null): string {
