...
import type { ProcessesDetails } from "../constants/index.ts";
...
The notify flags control whether YOU (the agent) get a turn to react (e.g. check results, fix code, restart).`,
    promptSnippet:
